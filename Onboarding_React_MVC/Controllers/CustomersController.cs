...
namespace Onboarding_React_MVC.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly MVPOnboardingTaskDbContext _context;

        public CustomersController(MVPOnboardingTaskDbContext context)
        {
            _context = context;
        }
